...
public class KeyProcessor{
	...
	public static void processKey(char key){
		...
		case '$':
			...
			}else if(Main.character.getTag().equals("walkleft1") || Main.character.getTag().equals("walkleft2")|| Main.character.getTag().equals("walkleft3") || Main.character.getTag().equals("walkleft4")) {
